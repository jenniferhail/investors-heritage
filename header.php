...
<head>
	...
	<!-- Disable IE Edge detection of phone numbers -->
	...
	})(window,document,'script','dataLayer','GTM-WPQB936');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WPQB936"
...
<!-- End Google Tag Manager (noscript) -->
	...
	<?php
        $nav_settings = get_field('nav_settings');
        $nav_pos = $nav_settings['position'];
        if ($nav_pos == null) {
            $nav_pos = 'stack';
		}
		$menu_override = get_field('override_main_menu');
		$desktop_menu = 'main-menu';
		$mobile_menu = 'mobile-menu';
		if($menu_override){
			$desktop_menu = get_field('desktop_menu');
			$mobile_menu = get_field('mobile_menu');
		}
    ?>

	<header class="header padding-sides <?php echo $nav_pos; ?>" role="banner">
		<div class="wrapper">
			<div class="grid-row space-between">
				<div class="col logo-wrap">
					<div class="ih-logo">
						<a href="/" alt="Investors Heritage – Life Insurance Company">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 565.5 136.5" preserveAspectRatio="xMinYMin meet"><style type="text/css">
				...
				<div class="col">
					...
					<nav class="nav grid-row" role="navigation">

						<ul class="header-nav grid-col large-grid-row">
						...
						<div class="mobile-nav-btn">
							<div class="btn-line line-1"></div>
							<div class="btn-line line-2"></div>
							<div class="btn-line line-3"></div>
						</div>
